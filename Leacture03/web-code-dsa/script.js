...
const ai = new GoogleGenAI({
    apiKey: "AIzaSyB-043x7soqCgr_5dfAbvd7oMn459S-HPs" // Replace with your actual API key
});
...
const chat = ai.chats.create({
    ...
    config: {
        ...
        - If user asks question not related to coding, tell them directly that you only answer problems related to coding or you can use slang 
